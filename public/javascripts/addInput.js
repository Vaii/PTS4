...
function addInput(divName){
    ...
    newdiv.innerHTML = "<div class=\"col-lg-3\"><label class=\"form-control-label\" for=\"date[]\">Datum:</label>" +
...
function addInputEdit(divName){
    ...
    var newdiv = document.createElement('div');
    newdiv.className = "row col-lg-12 row" + numItems;
    newdiv.innerHTML = "<div class=\"col-lg-5\"><label class=\"form-control-label\" for=\"date[]\">Datum:</label>" +
        "<input type=\"datetime-local\" id=\"dates\" name=\"date[]\" value=\"\" required=\"true\" class=\"form-control dateInput\"></div>" +
